...
import Contact from "../Models/contact1";
...
export function DisplayContactListPage(req: Request, res: Response, next: NextFunction): void
{
    Contact.find(function(err, contactCollection){
        ...
        res.render('index',{title: 'Bussiness Contact List', page: 'contact-list1', contacts: contactCollection, displayName: UserDisplayName(req)} )
    });
}
